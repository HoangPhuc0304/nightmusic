function changeTimeFromSecondForSong(seconds) {
...
function changeTimeFromSecondForPlaylist(seconds) {
  seconds = Math.floor(seconds)
  const hour = Math.floor(seconds / 3600)
  const minute = Math.floor((seconds - hour * 3600) / 60)
  const second = seconds - hour * 3600 - minute * 60
...
export { changeTimeFromSecondForSong, changeTimeFromSecondForPlaylist }
